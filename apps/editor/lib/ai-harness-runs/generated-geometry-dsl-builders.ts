...
import {
  ...
  buildBucketElevator,
  buildRotaryValve,
  buildCycloneSeparator,
  buildAirCooler,
  type AgitatorTankParams,
  type AirCoolerParams,
  type BlowerPackageParams,
  type BucketElevatorParams,
  type BearingBlockParams,
  type BoxFrameParams,
  type BeltParams,
  ...
  type RotaryValveParams,
  type ScrewConveyorParams,
...
export function createDslApiBuilders(opts: CreateBuildersOptions) {
  ...
  return {
    ...
    firedHeater: (o: FiredHeaterParams) => registerEquipmentSpecs(buildFiredHeater(o)),
    chimney: (o: ChimneyParams) => registerEquipmentSpecs(buildChimney(o)),
    coolingTower: (o: CoolingTowerParams) => registerEquipmentSpecs(buildCoolingTower(o)),
    flareTower: (o: FlareTowerParams) => registerEquipmentSpecs(buildFlareTower(o)),
    screwConveyor: (o: ScrewConveyorParams) => registerEquipmentSpecs(buildScrewConveyor(o)),
    silo: (o: SiloParams) => registerEquipmentSpecs(buildSilo(o)),
    bucketElevator: (o: BucketElevatorParams) => registerEquipmentSpecs(buildBucketElevator(o)),
    rotaryValve: (o: RotaryValveParams) =>
      registerEquipmentSpecs(buildRotaryValve(o)),
    cycloneSeparator: (o: CycloneSeparatorParams) => registerEquipmentSpecs(buildCycloneSeparator(o)),
    airCooler: (o: AirCoolerParams) => registerEquipmentSpecs(buildAirCooler(o)),
