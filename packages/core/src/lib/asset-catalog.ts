...
export const CATALOG_ITEMS: AssetInput[] = [
  ...
  },
  {
    ...
    ...iconOnly('factory-electric-box', '/icons/appliance.webp'),
  ...
  },
  {
    ...
    ...iconOnly('factory-straight-pipe', '/icons/shelf.webp'),
  ...
  },
  {
    ...
    tags: ['floor', 'pipe', 'industrial', 'factory'],
    ...iconOnly('factory-curved-pipe', '/icons/shelf.webp'),
  ...
  },
  {
    ...
    name: 'Factory T Pipe',
    tags: ['floor', 'pipe', 'industrial', 'factory'],
    ...iconOnly('factory-t-pipe', '/icons/shelf.webp'),
  ...
  },
  {
    ...
    ...iconOnly('factory-extractor', '/icons/appliance.webp'),
  ...
  },
  {
    ...
    ...iconOnly('factory-barrel', '/icons/shelf.webp'),
  ...
  },
  {
    ...
    name: 'Shower',
    tags: ['floor', 'bathroom', 'plumbing'],
    ...iconOnly('shower', '/icons/appliance.webp'),
  ...
  },
  {
    ...
    name: 'Tub',
    tags: ['floor', 'bathroom', 'plumbing'],
    ...iconOnly('tub', '/icons/appliance.webp'),
    dimensions: [1.7, 0.55, 0.75],
  },
  {
    id: 'wall-sink',
...
export function searchCatalogItems(args: {
  ...
  const requestedCategory = args.category?.trim().toLowerCase()
  ...
  return CATALOG_ITEMS.filter((item) => {
    ...
    if (
      ...
      !tags.some((tag) => tag.toLowerCase() === requestedCategory)
    ) {
      return false
    }
    const haystack = [item.id, item.name, item.category, ...tags].join(' ').toLowerCase()
